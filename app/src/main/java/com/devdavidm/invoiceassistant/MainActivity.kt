package com.devdavidm.invoiceassistant
...
import com.devdavidm.invoiceassistant.loginbutton.LoginButton
import com.devdavidm.invoiceassistant.ui.theme.InvoiceAssistantTheme

class MainActivity : ComponentActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContent {
            InvoiceAssistantTheme {
